...
constexpr unsigned RND_TEST  = 1000000;
...
// *************************************************************************
// LEVEL 2: Odebrani prvku (vic moznosti implementace mazani, mozna nebudou asserty fungovat)
// *************************************************************************
#ifdef LEVEL2
    std::cout << "Level 2:   ";
...
// *************************************************************************
    ...
    std::cout << "Level 5 dosazen, cviko 4 hotove!" << std::endl;
...
// *************************************************************************
    ...
    std::cout << "Vse je hotovo! Progtest bude pohodicka" << std::endl;
